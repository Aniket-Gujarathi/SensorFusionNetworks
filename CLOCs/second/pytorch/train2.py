...
def train(config_path,
    ...
    ### CenterPoint ########
    cfg_centerpoint = Config.fromfile(cfg_centerpoint)
    net = build_detector(cfg_centerpoint.model, train_cfg=None, test_cfg=cfg_centerpoint.test_cfg)
    #########################
    ...
    # Nuscenes data
    dataset = build_dataset(cfg_centerpoint.data.train)
    eval_dataset = build_dataset(cfg_centerpoint.data.val)
